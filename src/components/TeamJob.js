...
class TeamJob extends Component{
    render(){
        ...
        let data = [
            {jobTitle: "Nyamdavaa Amar", jobDesc: "Lorem Ipsum", jobLink: "/"},
            {jobTitle: "Ankhbayar Enkhtaivan", jobDesc: "here are many variations of passages", jobLink: "/"},
            {jobTitle: "Tsog Boldbaatar", jobDesc: "here are many variations of passages", jobLink: "/"}
        ];
